...
stargate/image_quality/templates/template2.pgm
stargate/image_quality/templates/template3.pgm
stargate/image_quality/templates/template4.pgm
...
libopencv_libjasper.so
libopencv_libjpeg.so
libopencv_libopenexr.so
libopencv_libpng.so
libopencv_libtiff.so
libopencv_ml.so
...
libopencv_structure_light.so
libopencv_superpixel.so
...
etc/RIDL/OriginalGoldenLog.dmc
